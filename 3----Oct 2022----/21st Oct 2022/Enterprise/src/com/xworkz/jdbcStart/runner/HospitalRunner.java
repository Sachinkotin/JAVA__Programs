...
public class HospitalRunner {
	...
	public static void main(String[] args) {
		...
		HospitalDTO hdto3 = new HospitalDTO(3, "Jay Ram", "Cardiac",10.00);
		HospitalDTO hdto4 = new HospitalDTO(4, "Venu", "ENT", 10.00);
		HospitalDTO hdto5 = new HospitalDTO(5, "Konimani", "Orthopedic", 12.00);
		HospitalDTO hdto6 = new HospitalDTO(6, "Mallayya", "General", 13.00);
		HospitalDTO hdto7 = new HospitalDTO(7, "Shetty", "Cardiac", 10.00);
		HospitalDTO hdto8 = new HospitalDTO(8, "Tippu", "ENT", 9.30);
		...
		HospitalDTO hdto13 = new HospitalDTO(13, "Karidigudda", "General", 12.00);
		HospitalDTO hdto14 = new HospitalDTO(14, "BTM layout", "Orthopedic", 15.00);
		HospitalDTO hdto15 = new HospitalDTO(15, "Srinagar", "Cardiac", 15.00);
		...
		HospitalDTO hdto21 = new HospitalDTO(21, "Melinamani", "Cardiac", 10.30);
		HospitalDTO hdto22= new HospitalDTO(22, "Kambibai", "General", 12.00);*/
	
		//HospitalDTO hdto23 = new HospitalDTO(23, "Suman", "ENT", 11.00);
		
		HospitalDTO hdto24 = new HospitalDTO(24, "Kishore", "ENT", 12.00);
		...
		//hsi.validateAndSave(hdto23);
		
		hsi.validateAndSave(hdto24);
